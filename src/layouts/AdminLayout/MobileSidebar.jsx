...
const Sidebar = () => {
    ...
    return (
        <>
            {/* Hamburger button */}
            <div className="flex justify-between items-center p-4 bg-[#000080] text-white fixed top-0 left-0 w-full z-20 lg:hidden">
            ...
            <aside
                className={`fixed top-0 left-0 z-30 h-full w-64 bg-[#000080] shadow-lg transition-transform transform ${
                    ...
                    <ul className="space-y-2 font-medium">
                        <li>
                            ...
                            >
                                ...
                                <span className="text-white text-lg ms-3">
                                    Dashboard
                                </span>
                            </NavLink>
                        </li>
