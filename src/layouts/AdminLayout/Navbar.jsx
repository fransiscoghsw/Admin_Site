...
const Navbar = (props) => {
    ...
    useEffect(() => {
        ...
        return () =>
            document.removeEventListener("mousedown", handleClickOutside); // Cleanup saat komponen di-unmount
    }, [isMenuOpen]);

    return (
        <>
            <nav className="bg-[#F5F5F7] md:ml-0 rounded-2xl shadow-md md:mt-0">
