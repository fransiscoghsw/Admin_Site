...
const Modal = (props) => {
    ...
    return (
        ...
        >
            {/* modal */}
            <div
                // Removed stopPropagation to prevent interference with nested components
...
const Header = (props) => {
    ...
    return (
        <div className="flex items-center p-4 md:px-5 md:pb-2 mt-5">
            <h3 className="text-2xl font-semibold text-[#000080]">{title}</h3>
            {children}
            <button
                onClick={onClose}
                type="button"
...
const Body = (props) => {
    ...
    return (
        <div className={`px-4 pb-4 md:px-5 md:pb-5 ${className}`}>
            {children}
        </div>
    );
};
...
const Footer = (props) => {
    ...
    return (
        <div className="flex items-center p-4 md:px-5 md:pb-5 mt-5 justify-end">
            <div className={`flex gap-2 ${action ? "grid grid-cols-2" : ""}`}>
                {action ? (
                    <>
                        <Button
