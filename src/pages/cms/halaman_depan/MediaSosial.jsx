...
const MediaSosial = () => {
    ...
    const handleInputChange = (e) => {
        ...
        if (!value.trim()) {
            ...
            setErrors((prevErrors) => ({
                ...prevErrors,
                [name]: "URL tidak valid. Harap masukkan URL yang benar (contoh: https://www.example.com)",
            }));
        } else {
            clearError(name);
        }
    ...
    const openModal = (type, socialMedia = null) => {
        ...
        if (type === "update_social_media" && socialMedia) {
            ...
            setPreviewIcon(
                `${import.meta.env.VITE_API_URL}/sosial-media/image/${
                    socialMedia.icon
                }`
            );
    ...
    return (
        <AdminLayout pageTitle={"Halaman Depan / Media Sosial"}>
                ...
                <div className="bg-[#F5F5F7] w-full rounded-2xl shadow-md py-4 px-6">
                    <div className="flex mb-6 justify-between">
                        ...
                        <Modal
                            ...
                            onClose={closeModal}
                            size={
                                modalType === "delete_social_media" ? "sm" : ""
                            }
                        >
