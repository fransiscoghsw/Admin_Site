...
const Kontak = () => {
    ...
    const handleChange = (e) => {
        ...
        if (!value.trim()) {
            ...
            setErrors((prevErrors) => ({
                ...prevErrors,
                [name]: "Email tidak valid. Harap masukkan email yang benar (contoh: admin@example.test)",
            }));
        } else if (
            name === "nomor_telepon" &&
            ...
            setErrors((prevErrors) => ({
                ...prevErrors,
                [name]: "Nomor telepon tidak valid. Harap masukkan nomor telepon yang benar (contoh: 08123456789)",
            }));
        } else {
            clearError(name);
        }
    ...
    return (
        <AdminLayout pageTitle={"Tentang Kami / Kontak"}>
